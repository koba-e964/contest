...
// Tags: number-of-surjections, exponential-generating-functions, ordinary-generating-functions
// Similar-problems: https://yukicoder.me/problems/no/2514
fn main() {
    ...
    for i in 0..3 {
        let mut tmp = vec![MInt::new(0); n + 1];
        for j in 0..n + 1 {
            if j % ints[i + 1] == 0 {
                tmp[j] += 1;
            }
